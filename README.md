...
대한민국 태양광 발전소 114,840건의 전기사업허가 데이터를 자동 수집·정제·지오코딩하여, PostGIS 기반 지리공간 대시보드로 시각화하는 풀스택 프로젝트입니다. 실시간 전력수요, PV 발전량, 기상 관측 데이터를 FDW(Foreign Data Wrapper)로 통합하여 에너지 인프라 현황을 한눈에 파악할 수 있는 프로젝트입니다.
